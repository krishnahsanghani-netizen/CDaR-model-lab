...
from enhanced_cdar.metrics.drawdown import compute_cumulative_value, compute_drawdown_curve, max_drawdown


@given(st.lists(st.floats(min_value=-0.2, max_value=0.2, allow_nan=False, allow_infinity=False), min_size=5, max_size=50))
